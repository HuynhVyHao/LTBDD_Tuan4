            ...
            <View style={{flexDirection:'row', width:328, height:45, marginBottom:80}}>
                <TouchableOpacity style={{width:110,
                    ...
                    <Image style={{width:30, height:30}}
                     source={require('../../Shopee/anh/fb.png')} resizeMode='stretch' />
                </TouchableOpacity>
                ...
                <Image style={{width:30,
                    height:30,}} 
                    source={require('../../Shopee/anh/icozalo.png')} resizeMode='stretch' />
                </TouchableOpacity>
                ...
                <TouchableOpacity style={{width:110,
                    ...
                    alignItems:'center'}}>
                <Image style={{width:30, height:30,}}
                    source={require('../../Shopee/anh/gg.png')} resizeMode='stretch' />
