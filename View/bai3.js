...
const ViewBai3 = () => {
  return (
        <View style={styles.container}>
          ...
          <Image source={require('../../Shopee/anh/lock.png')} resizeMode='stretch' style={styles.img} />
          <View>
          ...
          <View style={{marginHorizontal: 30}}>
            ...
            <View style={styles.wrapper}>
              <Image style={{ width: 48, height: 45 }} source={require('../../Shopee/anh/mail.png')} resizeMode='stretch' />
